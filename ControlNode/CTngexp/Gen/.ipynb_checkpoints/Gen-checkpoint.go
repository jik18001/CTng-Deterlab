...
func Generateall(num_ca int, num_logger int, num_gossiper int, Threshold int, num_cert int, MMD int, MRD int, config_path string) {
	Total := num_gossiper
	...
	monitor_public_config := GenerateMonitor_public_config(G_list, M_list, C_list, L_list, MMD, MMD, 10, []string{"1.1"})
	// Generate Monitor private config map
	monitor_private_config_map = GenerateMonitor_private_config_map(G_list, M_list, C_list, L_list, MMD, MMD, 10, []string{"1.1"}, " ")
	...
	gossiper_public_config := GenerateGossiper_public_config(G_list, M_list, C_list, L_list, MMD, MMD, 10, 10, []string{"1.1"})
	// Generate Gossiper private config map
	gossiper_private_config_map = GenerateGossiper_private_config_map(G_list, M_list, C_list, L_list, MMD, MMD, 10, 10, []string{"1.1"}, " ")
